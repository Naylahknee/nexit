...
const groups = [
  { title: 'Before you go', tasks: ['Passport valid', 'Research visa options', 'Request official records', 'Arrange travel insurance'] },
...
export function MoveChecklist({ initial }: { initial: RelocationProfile }) {
  ...
  async function toggle(task: string) {
    ...
    setCompleted(next); setSaving(task)
